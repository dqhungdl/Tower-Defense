...
public class Towers {
    ...
    public static final double[] AIR_GUN_SPEED = new double[]{0.5, 0.5, 0.5};
    public static final int[] AIR_GUN_RANGE = new int[]{150, 150, 150};
    public static final int[] AIR_GUN_DAMAGE = new int[]{1, 1, 1};
    public static final int[] AIR_GUN_MONEY = new int[]{25, 25, 25};
}
